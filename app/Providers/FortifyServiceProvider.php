    ...
    public function boot(): void
    {
        ...
        Event::listen(\Illuminate\Auth\Events\Login::class, function (\Illuminate\Auth\Events\Login $event) {
            ...
            if ($user->role === 'admin') {
                ...
                session(['redirect_after_login' => '/bidang/dashboard']);
            } else {
                session(['redirect_after_login' => '/dashboard']);
            }
        });

        Fortify::redirects('login', function () {
            return session('redirect_after_login', '/dashboard');
        });
    }
}
